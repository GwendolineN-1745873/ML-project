...
# Load synthetic data
synthetic_train_dataset = tf.keras.utils.image_dataset_from_directory(
    'synthetic_data',
    seed=123,
    image_size=(img_height, img_width),
    batch_size=batch_size
...
# Validation set from real images
validation_dataset_for_synth = load_data(data_folder + '/training', img_height, img_width, batch_size)
test_dataset_for_synth = load_data(data_folder + '/test', img_height, img_width, batch_size)
# ignore val for now
...
train_dataset = resize_images(synthetic_train_dataset)
validation_dataset = resize_images(validation_dataset_for_synth)
test_dataset = resize_images(test_dataset_for_synth)
...
# Save weights
model.save_weights(model_folder_name + '.weights' + '.h5')